...
export class Backend implements backendInterface {
    ...
    async getHistory(): Promise<Array<WordEntry>> {
        if (this.processError) {
            try {
    ...
    async lookupWord(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.lookupWord(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async storeWordEntry(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storeWordEntry(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
